...
<body>
    ...
    <div id="tab-gallery" class="tab-content active">
        <?php
        // Join dengan tabel events untuk mengambil nama event (jika foto terikat dengan event)
    ...
    <div id="tab-event" class="tab-content">
        <?php
        $query_ev = mysqli_query($conn, "SELECT * FROM events ORDER BY tanggal_event DESC");

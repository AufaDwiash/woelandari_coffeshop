...
<div class="blueprint-container">
    ...
    <div class="detail-section">
        ...
        <div class="menu-detail show" id="menu-detail">
            <div class="spec-header">
                ...
                <span class="spec-status text-red" id="detail-status">SISTEM SIAP</span>
            </div>

            <h1 class="spec-title" id="detail-title">PILIH MENU</h1>
            ...
            <div class="notebook-note">
                ...
                <p id="detail-desc" class="handwritten-text">Arahkan kursor dan pilih menu di samping untuk melihat detail menu.</p>
            </div>
        </div>
    </div>
    ...
    <div class="list-section">
        ...
        <div class="pagination-container">
            ...
            <span id="pageMenuInfo" class="page-info">HALAMAN 1 / 1</span>
